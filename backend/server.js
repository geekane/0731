...
// 中间件
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:3003', 'https://vakkrvxkxeee.us-east-1.clawcloudrun.com', 'https://vakkrvxkxeee.us-east-1.clawcloudrun.com/', 'https://jcwdemotest.pages.dev'], // 允许前端应用的域名
  credentials: true
}));
